...
const SERVICES = [
  {
    img: '.next/images/service-construction.jpg',
    icon: '🏗️',
  ...
  {
    img: '.next/images/service-architecture.jpg',
    icon: '📐',
  ...
  {
    img: '.next/images/service-management.jpg',
    icon: '📋',
  ...
  {
    img: '.next/images/service-realestate.jpg',
    icon: '🏢',
  ...
  {
    img: '.next/images/service-logistics.jpg',
    icon: '🚚',
  ...
  {
    img: '.next/images/service-hardware.jpg',
    icon: '🔧',
    ...
    <>
      ...
      <nav>
        <a href="#hero" className="nav-logo" onClick={scrollTo('hero')}>
          <img src=".next/images/logo.png" alt="NextGen Apex Masters Logo" onError={(e) => { e.target.style.display='none'; }} />
      ...
      <section id="hero">
        <div className="hero-bg">
          <img src=".next/images/hero-building.jpg" alt="" className="hero-bg-img" />
      ...
      <section id="about">
        <div className="about-inner">
          <div className="about-img-wrap">
            ...
            <img src=".next/images/about-team.jpg" alt="NextGen Apex Masters team and project" />
          </div>
          <div>
      ...
      <section id="cta-banner">
        <img src=".next/images/cta-background.jpg" alt="" className="cta-bg" />
      ...
      <footer id="contact">
        <div className="footer-inner">
          <div className="footer-brand">
            <img src=".next/images/logo.png" alt="NextGen Apex Masters" onError={(e) => { e.target.style.display = 'none'; }} />
            <p>
