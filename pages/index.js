...
const SERVICES = [
  {
    img: 'public/images/service-construction.png',
    icon: '🏗️',
  ...
  {
    img: 'public/images/service-architecture.png',
    icon: '📐',
  ...
  {
    img: 'public/images/service-management.png',
    icon: '📋',
  ...
  {
    img: 'public/images/service-realestate.png',
    icon: '🏢',
  ...
  {
    img: 'public/images/service-logistics.png',
    icon: '🚚',
  ...
  {
    img: 'public/images/service-hardware.png',
    icon: '🔧',
    ...
    <>
      ...
      <section id="hero">
        <div className="hero-bg">
          <img src="public/images/hero-building.png" alt="" className="hero-bg-img" />
      ...
      <section id="about">
        <div className="about-inner">
          <div className="about-img-wrap">
            ...
            <img src="public/images/about-team.png" alt="NextGen Apex Masters team and project" />
          </div>
          <div>
      ...
      <section id="cta-banner">
        <img src="public/images/cta-background.png" alt="" className="cta-bg" />
